...
import org.example.projetc_backend.dto.UserListeningAttemptSearchRequest; // Import DTO tìm kiếm mới
...
public class UserListeningAttemptController {
     ...
     * @param request DTO chứa thông tin cập nhật lần thử nghe.
     ...
     * @return ResponseEntity chứa Page của UserListeningAttemptResponse.
     */
    @GetMapping("/search")
